...
Este bloque contiene el `README.md` y el script de PowerShell necesarios para la compilación de tu aplicación 'MiAPP', listos para copiar y usar en tu repositorio de GitHub.
